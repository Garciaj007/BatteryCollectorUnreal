...
void ALab6Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Collect", IE_Pressed, this, &ALab6Character::CollectPickups);
...
void ALab6Character::CollectPickups()
{
...
float ALab6Character::GetInitialPower() { return InitialPower; }

float ALab6Character::GetCurrentPower() { return CharacterPower; }

void ALab6Character::UpdatePower(float PowerChange)
{
	//Change Power
